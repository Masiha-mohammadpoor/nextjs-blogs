...
const PostList = ({blogData}) => {
    ...
    return (
        <section className="col-span-12 md:col-span-9 grid grid-cols-6 gap-5 container mx-auto">
        {blogs.map((blog,index)=> {
          return <div className="flex flex-col overflow-hidden bg-gray-200 rounded-lg col-span-6 min-[480px]:col-span-3 lg:col-span-2" key={blog._id}>
            {/* blogs image */}
            ...
            <div className="p-3 flex flex-col justify-between flex-1">
              ...
              <div className="mb-3 w-full flex justify-between items-center">
                ...
                <button className="text-sm transition-all duration-300 px-2 rounded-2xl bg-blue-400 text-blue-700 hover:bg-blue-700 hover:text-white">{blog.category.title}</button>
              </div>
              {/* reaction */}
