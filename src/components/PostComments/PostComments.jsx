  ...
  return (
    <div>
      ...
      <form className="mt-10">
        ...
        className="mb-5 p-3 border-2 border-gray-500 rounded-md w-full h-32"></textarea>
        <button className="py-2 px-3 rounded-full bg-blue-600 text-white">ارسال نظر</button>
      </form>
    </div>
  );
};
